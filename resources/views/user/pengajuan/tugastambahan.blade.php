                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="text-sm-right">
                                                    ...
                                                    <a href="{{ route('pengajuan-realisasi.index') }}"
                                                        class="btn btn-success btn-sm mb-2"> <i
                                                            class="mdi mdi-plus-circle mr-1"></i>Realisasi SKP</a>
...
@push('js')
    <script>
        ...
        function realisasi(id) {
            ...
            $("#keterangan").val('');
            console.log(id);
            $("#aktivitas").val(id.tugas);
            $("#targetkuantitas").val(id.tkuantitas + ' - ' +
                id.tkuantitasmax);
            $("#realisasikuantitas").val(id.rkuantitas);
            $("#skuan").html(id.satuankuantitas);


            $("#targetkualitas").val(id.tkualitas + ' - ' +
                id.tkualitasmax);
            $("#realisasikualitas").val(id.rkualitas);
            $("#skual").html(id.satuankualitas);
            $("#rkual2").html(id.satuankualitas);


            $("#targetwaktu").val(id.twaktu + ' - ' +
                id.twaktumax);
            $("#realisasiwaktu").val(id.rwaktu);
            $("#swaktu").html(id.satuanwaktu);
            $("#rwaktu").html(id.satuanwaktu);

            $("#rkuan").html(id.satuankuantitas);
            $("#idtugas").val(id.id);
        }
        ...
        $("#subtar").submit(function(e) {
            ...
            $.ajax({
                url: "{{ route('pengajuan-realisasi-tugas.store') }}",
                data: data,
                type: 'post',
                success: function(e) {
