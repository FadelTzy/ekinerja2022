...
@section('body')
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box page-title-box-alt">
                        <h4 class="page-title">Tugas Tambahan {{ $period->nama_periode }}</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Menu</a></li>
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Tugas Tambahan</a></li>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    @else
                        @if ($jab->status_tugas == null)
                            <div class="d-flex justify-content-between alert alert-danger ">
                                <h4 class="page-title">Anda Belum Menyusun Tugas Tambahan
                                    {{ $period->nama_periode }} </h4>
                            </div>
                        @elseif($jab->status_tugas == 1)
                            <div class=" alert alert-success ">
                                <h4 class="page-title">Tugas Tambahan Telah Disetujui {{ $period->nama_periode }}
                                </h4>
                            </div>
                        @elseif($jab->status_target == 2)
                            <div class="alert alert-warning d-flex justify-content-between">
                                <h4 class="page-title">Tugas Tambahan Di Tolak, Silahkan Menyusun Ulang
                                    {{ $period->nama_periode }} </h4>
                                <div>
                        ...
                        @elseif($jab->status_target == 3)
                            <div class=" alert alert-primary ">
                                <h4 class="page-title">Menunggu Persetujuan Tugas Tambahan, Silahkan Menghubungi
                                    Atasan</h4>
                            </div>
                        @endif
                    @endif
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-right">
                                    @if ($jab->status_target != 0 && ($jab->status_tugas == null || $jab->status_tugas == 3))
        ...
        <div class="modal-dialog modal-full-width">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="fullWidthModalLabel">Tugas Tambahan</h4>
                            ...
                            <form method="post" id="subtar" action="#">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <label for="inputEmail1">Tugas Tambahan</label>
    ...
    <div id="full-width-modal2" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="fullWidthModalLabel"
        ...
        <div class="modal-dialog modal-full-width">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="fullWidthModalLabel">Tugas Tamabahan</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-body">
                    <div class="row">
...
@push('js')
    ...
    <script>
        ...
        function editj(e) {
            ...
            $("#aktivitasu").val(e.tugas);
            $("#keteranganu").summernote("code", e.keterangan);
        ...
        $("#subtar").submit(function(e) {
            ...
            $.ajax({
                url: "{{ route('tugas-tambahan.store') }}",
                data: data,
                type: 'post',
                success: function(e) {
