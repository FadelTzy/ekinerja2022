...
@endsection
@section('breadcrumb')
<h4 class="page-title">Tabel Jabatan Fungsionl Dosen</h4>
<div class="page-title-right">
    <ol class="breadcrumb m-0">
        <li class="breadcrumb-item"><a href="javascript: void(0);">Data Master</a></li>
        <li class="breadcrumb-item active"><a href="javascript: void(0);">Jabatan Fungsionl Dosen</a></li>
    </ol>
</div>
@endsection
