...
@endsection
@section('breadcrumb')
    <h4 class="page-title">Tabel Jenjang Jabatan</h4>
    <div class="page-title-right">
        <ol class="breadcrumb m-0">
            <li class="breadcrumb-item"><a href="javascript: void(0);">Data Master</a></li>
            <li class="breadcrumb-item active"><a href="javascript: void(0);">Jenjang</a></li>
        </ol>
    </div>
@endsection
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Tambah Jenjang Jabatan</h4>
                        ...
                        <div class="modal-body py-2 px-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="jenjang" required placeholder="Input jenjang"
                                                id="jenjang" class="form-control">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group mb-2">
                                        <div class="form-group">
                                            <label for="max" class="control-label">Level Maksimal</label>

                                            <input type="text" name="max" placeholder="Input max" id="max"
                                                class="form-control">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group mb-2">
                                        <div class="form-group">
                                            <label for="min" class="control-label">Level Minimal</label>

                                            <input type="text" name="min" placeholder="Input min" id="min"
                                                class="form-control">
