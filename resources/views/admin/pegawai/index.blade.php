        ...
        <div class="card">
            <div class="card-body">
                ...
                <div id="tabelpos" class="table-responsive">
                    <table class="table table-sm table-centered w-100 dt-responsive" id="products-datatable2" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
    ...
    $(document).ready(function(e) {
        ...
        let tabel = $("#products-datatable2").DataTable({
            ...
            columns: [{
                ...
                {
                    name: 'statusJabFungsionalBKD',
                    data: 'statusJabFungsionalBKD',
                },
            ]
        });
        sinkron = function() {
