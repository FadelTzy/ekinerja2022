...
@endsection
@section('breadcrumb')
<h4 class="page-title">Rincian Tugas Jabatan {{$tupoksi->jabatan}} </h4>
<div class="page-title-right">
    <ol class="breadcrumb m-0">
        <li class="breadcrumb-item"><a href="javascript: void(0);">Data Master</a></li>
        <li class="breadcrumb-item active"><a href="javascript: void(0);">Tupoksi</a></li>
        <li class="breadcrumb-item active"><a href="javascript: void(0);">{{$tupoksi->jabatan}} </a></li>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="header-title">Kode Jabatan : {{$tupoksi->kode}}</h4>
                    ...
                    <div class="col-sm-6">
                        <div class="float-sm-right">
                            <a href="{{asset('template.csv')}}" class="btn btn-danger mb-2" type="button" data-toggle="modal" data-target="#upload"><i class="mdi mdi-plus mr-1"></i></a>

                            <button class="btn btn-warning mb-2" type="button" data-toggle="modal" data-target="#upload"><i class="mdi mdi-upload mr-1"></i>Upload File</button>
                            ...
                            <form name="add_name" id="add_name">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <a class="btn btn-primary" href="{{route('jabatans.index')}}">Kembali</a>
...
<script>
    ...
    $('#add').click(function() {
        i++;
        $(".ww").hide();
        $('#dynamic_field').append('<tr id="row' + i + '"><td style="width: 95%;" ><input type="text" name="name[]" placeholder="Input Rincian Tugas" class="form-control name_list mb-2" /><input type="text" name="name[]" placeholder="Input Hasil Kerja" class="form-control name_list" /></td><td><button type="button" name="remove" id="' + i + '" class="btn btn-danger btn_remove">X</button></td></tr>');
    });
