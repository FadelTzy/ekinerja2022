...
<body>
    ...
    <table class="table table-bordered table-hover table-striped">
        ...
        <tbody>
            ...
            @foreach($t->indexes as $in)
            <tr>
                <td></td>
                <td>>>Target Bulan {{$t->{$in}->bulan}}</td>
                <td class="tc">0</td>
                <td class="tc">{{$t->{$in}->tkuantitas}} {{$t->{$in}->satuan}}</td>
                <td class="tc">100</td>
                <td class="tc">1 Bulan</td>
                <td class="tc">Rp. 0</td>
                <td class="tc">0</td>
                <td class="tc">{{$t->{$in}->rkuantitas}} {{$t->{$in}->satuan}}</td>
                <td class="tc">{{$t->{$in}->nilai_atasan}}</td>
                <td class="tc">1 Bulan</td>
                <td class="tc">Rp. 0</td>
                <td></td>
                <td></td>
